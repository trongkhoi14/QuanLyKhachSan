    ...
    public partial class fThanhToan : Form
    {
        ...
        private void fThanhToan_Load(object sender, EventArgs e)
        {
            ...
            chuyenKhoanTBox.Text += "Vui lòng chuyển khoản tiền cọc vào tài khoản sau, chậm nhất là vào ngày đến\r\n" +
                                    ...
                                    $"Nội dung: Tien coc phieu dat phong: ...\r\n" +
                                    $"(Khách hàng thay thế ... bằng mã phiếu đặt phòng, vd: PDP001)";
            ChuYTBox.Text += "+ Chúng tôi không chịu trách nhiệm với những đơn hàng chuyển không đủ tiền.\r\n" +
                            ...
                            "+ Trong trường hợp bạn điền sai thông tin hoặc có bất kỳ sự cố gì khiến hệ thống không thể tự động kích hoạt,\r\n" +
                            "vui lòng Liên hệ 0856253294 để được hỗ trợ sớm nhất";
        }
    }
}
